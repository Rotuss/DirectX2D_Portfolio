...
void GameEngineShaderResourcesHelper::ShaderCheck(GameEngineShader* _Shader)
{
	...
	{
		std::multimap<std::string, GameEngineConstantBufferSetter>::iterator InsertIter = ConstantBufferMap.insert(std::make_pair(Data.first, Data.second));
	...
	{
		std::multimap<std::string, GameEngineTextureSetter>::iterator InsertIter = TextureSetterMap.insert(std::make_pair(Data.first, Data.second));
	...
	{
		std::multimap<std::string, GameEngineSamplerSetter>::iterator InsertIter = SamplerSetterMap.insert(std::make_pair(Data.first, Data.second));
